...
- If you need to spawn an agent for exploration or research, select a model appropriate for the task. If it's not obvious which model to select, you should ask instead of guessing.
